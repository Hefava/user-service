...
public class UserValidationMessages {
  ...
  public static final String TOKEN_VALIDO = "El token es válido";
  public static final String TOKEN_INVALIDO_DESCRIPCION = "El token proporcionado es inválido o ha expirado";
}
